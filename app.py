...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    # OPTIMIZATION: Use deque for O(1) pops and an auxiliary set for O(1) containment checks
    ...
    while queue and count < max_pages:
        ...
        try:
            ...
            for link in soup.find_all('a', href=True):
                ...
                # OPTIMIZATION: Perform fast O(1) checks before expensive string parsing
