...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    # OPTIMIZATION: Use collections.deque for O(1) pops and queued_urls set for O(1) contains checks.
    ...
    while queue and count < max_pages:
        ...
        try:
            ...
            for link in soup.find_all('a', href=True):
                ...
                # OPTIMIZATION: Check fast O(1) set membership before expensive string parsing.
