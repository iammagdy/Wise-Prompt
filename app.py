...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    # ⚡ Bolt optimization: Use deque for O(1) pops and a set for O(1) queue containment checks
    # Replaces O(N) list operations which caused heavy CPU load during deep crawls
