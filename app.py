...
def recursive_crawl(start_url, max_pages=5):
    ...
    # ⚡ Bolt Optimization: Auxiliary set for O(1) containment checks instead of O(N) list 'in' checks
    ...
    while queue and count < max_pages:
        ...
        try:
            ...
            for link in soup.find_all('a', href=True):
                ...
                # ⚡ Bolt Optimization: O(1) set checks before expensive string operations (urlparse)
