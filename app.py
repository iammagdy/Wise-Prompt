...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    queue = collections.deque([start_url]) # ⚡ Bolt: Use deque for O(1) popleft
    queued_urls = {start_url} # ⚡ Bolt: Fast O(1) containment check
    combined_text = ""
    site_structure = {} 
    ...
    while queue and count < max_pages:
        ...
        try:
            ...
            for link in soup.find_all('a', href=True):
                ...
                # ⚡ Bolt: Check fast O(1) sets before expensive urlparse
