...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    queue = deque([start_url])  # OPTIMIZATION: O(1) pops from left
    queued_urls = {start_url}   # OPTIMIZATION: O(1) containment checks
    combined_text = ""
    site_structure = {} 
    ...
    while queue and count < max_pages:
        ...
        try:
            ...
            for link in soup.find_all('a', href=True):
                ...
                # OPTIMIZATION: Fast O(1) checks before expensive urlparse()
