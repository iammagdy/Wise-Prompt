...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    queue = [start_url]
    combined_text_list = []  # Bolt: Optimized string concatenation
    site_structure = {}
    ...
    # Bolt: Use Session for connection pooling (Performance)
    with requests.Session() as session:
        ...
        while queue and count < max_pages:
            ...
            try:
                ...
                # Bolt: Append to list instead of string concatenation
