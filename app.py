...
def recursive_crawl(start_url, max_pages=5):
    ...
    with requests.Session() as session:
        while queue and count < max_pages:
            ...
            # ⚡ Performance: O(1) pop from deque
            url = queue.popleft()
            ...
            try:
                ...
                # Bug fix: Aggregate images
                all_assets['images'].update(page_assets['images'])

                # ⚡ Performance: Use list append instead of string concatenation
