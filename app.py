...
def recursive_crawl(start_url, max_pages=5):
    # Optimized: Using deque for O(1) pops
    # and queued_urls for O(1) membership checks
    visited = set()
    ...
    while queue and count < max_pages:
        ...
        try:
            ...
            # Use list append instead of string concatenation for performance
            ...
            for link in soup.find_all('a', href=True):
                ...
                # Check queued_urls for O(1) lookup
                if (urlparse(full_url).netloc == base_domain and
                        full_url not in visited and
                        full_url not in queued_urls):
    ...
    return "".join(combined_text_list), site_structure, final_assets, global_stats
