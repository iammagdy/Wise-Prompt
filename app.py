...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    # ⚡ Bolt Optimization: Use deque for O(1) pops and a set for O(1) containment checks
    # This prevents the queue list from bottlenecking the crawl on large sites.
    ...
    while queue and count < max_pages:
        ...
        try:
            ...
            for link in soup.find_all('a', href=True):
                ...
                # ⚡ Bolt Optimization: Reorder checks to do fast O(1) set lookups before expensive urlparse
