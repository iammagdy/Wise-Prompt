...
def recursive_crawl(start_url, max_pages=5):
    # Optimization: Use deque for O(1) pops and requests.Session for connection reuse
    visited = set()
    queue = deque([start_url])
    text_parts = []  # Optimization: Use list accumulation instead of string concatenation
    site_structure = {} 
