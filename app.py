...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    queue = [start_url]
    combined_text_list = []  # OPTIMIZATION: Use list for string concatenation
    site_structure = {}
    ...
    # OPTIMIZATION: Use requests.Session() to reuse TCP connections
    ...
    return "".join(
        combined_text_list), site_structure, final_assets, global_stats
