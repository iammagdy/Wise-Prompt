...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    # ⚡ Bolt Optimization: Use deque for O(1) pops and a set for O(1) lookup
    # instead of O(N) list operations. This prevents severe execution spikes under heavy load.
