...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    queue = [start_url]
    combined_text_list = []  # Bolt Optimization: Use list for O(1) appends
    site_structure = {}
    ...
    # Bolt Optimization: Use Session for connection pooling (reuses TCP connections)
    with requests.Session() as session:
        ...
        while queue and count < max_pages:
            ...
            try:
                ...
                # Bolt Optimization: Append to list instead of string concatenation
    ...
    # Bolt Optimization: Join list once at the end
