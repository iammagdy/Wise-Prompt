...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    queue = [start_url]
    # PERFORMANCE OPTIMIZATION: Use a list for string accumulation
    # and join at the end. Concatenating large strings in a loop is O(n^2).
    combined_text_list = []
    site_structure = {}
    ...
    # PERFORMANCE OPTIMIZATION: Use requests.Session() to reuse TCP connections
    # and SSL handshakes across multiple requests to the same host.
    with requests.Session() as session:
        ...
        while queue and count < max_pages:
            ...
            try:
                ...
                # Append to list instead of concatenating string
