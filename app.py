...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    queue = [start_url]
    combined_text_parts = []  # Bolt: Optimized list append vs string concatenation
    site_structure = {}
    ...
    # Bolt: Use requests.Session for connection pooling (Keep-Alive)
    with requests.Session() as session:
        while queue and count < max_pages:
            ...
            try:
                ...
                # Bolt: Reusing session for faster consecutive requests
                ...
                # Bolt: Efficient string construction
