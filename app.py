...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    queue = [start_url]
    combined_text_list = []  # OPTIMIZATION: Use list for string accumulation
    site_structure = {} 
    ...
    # OPTIMIZATION: Use requests.Session for connection reuse
    with requests.Session() as session:
        while queue and count < max_pages:
            ...
            try:
                ...
                # OPTIMIZATION: Use session.get instead of requests.get
