...
def recursive_crawl(start_url, max_pages=5):
    visited = set()
    # ⚡ Bolt Optimization: Use collections.deque for O(1) pops and queued_urls set for O(1) membership check
    ...
    while queue and count < max_pages:
        ...
        try:
            ...
            for link in soup.find_all('a', href=True):
                ...
                # ⚡ Bolt Optimization: Check O(1) sets before expensive O(N) string parsing `urlparse`
